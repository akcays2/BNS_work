...
%
  ...
  \onslide<2->
  {
    ...
    \begin{footnotesize} 
    \[
    \rho_{\text{tot},\bigtriangleup} = \left[\sum_{A=1}^3 \left(\rho^A\right)^2\right]^{1/2}  =  A \rho_c \,|Q(\theta,\phi,\psi,\iota)|_\bigtriangleup %\int_0^{f_\text{ISCO}} d f\, \f{f^{-7/3}}{S_n(f)} \,
    \]
    \end{footnotesize}
    \\
  }
...
\begin{tikzpicture}[overlay,remember picture]
  \onslide<1->\node[draw, red,thick,minimum width=2.8cm,minimum height=1.0cm] (b) at (-0.7,5.3){};
...
\begin{frame}{The era of Einstein Telescope}{GRB \red{Forecast} Prospects } 
  ...
  \begin{tikzpicture}[overlay,remember picture]
      \onslide<3>\node[draw, blue,thick,minimum width=1.4cm,minimum height=1.6cm] (b) at (-2.6,5.3){};
