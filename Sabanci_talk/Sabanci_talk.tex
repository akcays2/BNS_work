...
\begin{small}
    \begin{itemize}
      ...
      \uncover<2->\item Non-thermal spectrum: $10-10^4\,$keV
      \uncover<3->{\item Highly energetic $10^{48}-10^{52}\,$ergs 
      \item 1000s detected, $\sim 1$ per day}
      \uncover<4->\item Far away: $z\approx 9.4 \sim 13\,$billion light years!
      \uncover<5->\item Afterglow from X-rays to radio \\
      over timescales of hours to months
      \uncover<6->\item Two types: short and long
      \uncover<7->{\item Short GRBs:\\ 
...
\begin{frame}{Neutron Stars}{Most extreme stars in the universe}
  Stellar evolution -> white dwarf, NS -> BH \\
  Density, mass, radius, spin, nuclear equation of state\\
  Tea spoon of neutron star matter trillion tons
\end{frame}
...
\begin{frame}{Making gravitational waves}{non-spherical, accelerated motion}
  ...
  \onslide<2->{{\bf Binary systems:} 2 points masses in circular orbit.}
  \begin{tikzpicture}[overlay,remember picture]
...
%
\begin{tikzpicture}[overlay,remember picture]
  \node[draw, red,thick,minimum width=9.2cm,minimum height=1.3cm] (b) at (5.,3.35){};
  \node[draw, red,thick,minimum width=9cm,minimum height=1.3cm] (b) at (4.4,1){};
...
\begin{frame}{Gravitational waves from BNS}
  ...
  %
  \begin{tikzpicture}[overlay,remember picture]
    \node (img0 )[anchor=center,scale=1,opacity=1] at ([shift={(2.7cm,-3.2cm)}]current page.center) {\includegraphics[height=2.5cm]{figs/Chirp.pdf}};
