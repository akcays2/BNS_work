...
\begin{tikzpicture}[overlay,remember picture]
    ...
    \onslide<1->\node (t1 )[anchor=center,scale=1,opacity=1] at ([shift={(3cm,-0.3cm)}]current page.center) 
    {\begin{footnotesize} 
      $   \bar\rho_c(\red{f_0}) \equiv 2 h_0 \left[ \int_{\red{f_0}}^{{f_\text{ISCO}}} df \f{f^{-7/3}}{S_n(f)}  \right]^{1/2} $      
    \end{footnotesize}}; 
    \onslide<1->\node (t2 )[anchor=center,scale=1,opacity=1] at ([shift={(3cm,-1.3cm)}]current page.center) 
    {\begin{footnotesize} 
      $ \left\{ \tilde{A}_h = \tfrac{4}{5}A,  \tilde{A}_m =\tfrac{2}{5}A,  \tilde{A}_l  < \tfrac{\tilde{A}_m}{2}\right\}$    
    \end{footnotesize}};  
    \onslide<1->\node (t3 )[anchor=center,scale=1,opacity=1] at ([shift={(3cm,-2.3cm)}]current page.center) 
    {\begin{footnotesize} 
      $\bar\rho_h = 29.2,\quad \bar\rho_m = 14.6,\quad \bar\rho_l = 6.11 $    
    \end{footnotesize}}; 
    \onslide<1->\node (t4 )[anchor=center,scale=1,opacity=1] at ([shift={(3cm,-2.6cm)}]current page.center) 
    {\begin{footnotesize} 
      $\bar\rho_\text{L1} = 26.4 \quad 18.8 \quad 2.0 $    
    \end{footnotesize}};
    \onslide<1->\node (t4 )[anchor=center,scale=1,opacity=1] at ([shift={(3cm,-2.6cm)}]current page.center) 
    {\begin{footnotesize} 
      $\rho_\text{tot} = 32.6 $    
...
\begin{frame}{GW Astronomy in the 2020s}
