...
\begin{frame}{The era of Einstein Telescope}{BNS detections}
 Same detection criterion:\qquad $\bar{\rho}_\text{ET}(f_0, \bar{f}_\text{ET}) =15$ \todo{ADD LIGO2017}\\
 \red{Two} ET configurations: B (high $f$), C (low $f$)\todo{2020 to plot}
 \begin{tikzpicture}[overlay,remember picture]
      \onslide<1->\node (img0 )[anchor=center,scale=1,opacity=1] at ([shift={(0cm,-1.5cm)}]current page.center) {\includegraphics[height=6cm]{../Figures/ET_strains_redshifted.pdf}};
      %\onslide<2->\node (img0 )[anchor=center,scale=1,opacity=1] at ([shift={(0cm,-1.5cm)}]current page.center) {\includegraphics[height=6cm]{../Figures/ET_strains_redshifted.pdf}};
      %\onslide<3->\node (img0 )[anchor=center,scale=1,opacity=1] at ([shift={(0cm,-1.5cm)}]current page.center) {\includegraphics[height=6cm]{../Figures/ET_strains_redshifted.pdf}};
      %\onslide<4->\node (img0 )[anchor=center,scale=1,opacity=1] at ([shift={(0cm,-1.5cm)}]current page.center) {\includegraphics[height=6cm]{../Figures/ET_strains_redshifted.pdf}};
\end{tikzpicture}      
