...
\begin{frame}{The era of Einstein Telescope}{GRB \red{Forecast} Prospects } 
  ...
  600 & $\approx\,$26.0  &65.8\,seconds & 50.2& $ 333^{1020}_{69} $ &    $\approx\,$5.7 & 1.03\,hours & 60.0  \\
  \hline\hline
  %bottomrule
  \end{tabular}
  ...
  \begin{tikzpicture}[overlay,remember picture]
      \onslide<3>\node[draw, blue,thick,minimum width=1.8cm,minimum height=1.6cm] (b) at (-2.3,5.3){};
...
\begin{frame}{The era of Einstein Telescope}{Source localization before the merger} 
  ...
  \onslide<4->\item[]$\Longrightarrow \red{\ord(5)}$ sources within 400\,Mpc
  \end{itemize}
...
\begin{frame}{Making gravitational waves}{non-spherical, accelerated motion}
 ...
 Underground,cryogenic, \blue{xylophone} (high, low-frequency modes)\\
