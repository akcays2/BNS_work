...
\begin{frame}{Binary Neutron Star Inspirals}{\todo{Add $r(t)$ plot? }}
...
\begin{align}
 ...
 &\simeq \bl{16.72\,\text{minutes}} \, \left(\f{1.219 M_\odot}{M_c}\right)^{5/3}\,\red{\left(\f{10\,\text{Hz}}{f}\right)^{8/3}\quad(2)}\nn
\end{align}
...
\begin{align}
 ...
 &\approx 1.605\times \bl{10^4}\,\left(\f{1.219 M_\odot}{M_c}\right)^{5/3}\red{ \left(\f{10\,\text{Hz}}{f} \right)^{5/3}}\quad \red{(3)}\nn
\end{align}
%
\begin{tikzpicture}[overlay,remember picture]
