...
Here, we are interested  in exploring the predictive power of near-future ground-based GW detectors and leave the task of reducing the latency to the experts.
...
We proceed as follows: Sec.~\ref{sec:BNS_inspiral} introduces the formulation for the leading-order evolution of the binary inspiral.
Sec.~\ref{sec:IFO_response} IFO response

Sec.~\ref{sec:idealizations} idealizations
