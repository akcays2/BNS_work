...
Be that as it may, we see that ET-C sensitivity still yields advance warning times $> 1\,$hour for sources within $\approx 450$\,Mpc. Therefore, our conclusions that we expect ET-C to forecast $\gtrsim 5$ yearly
BNS mergers holds.
...
Therefore, erring on the side of optimism, we conclude that the 2030s hold in store real-time 
electromagnetic observations of at least dozens of gamma-ray bursts and the subsequent kilonovae
...
%\section{Binary black hole inspirals}\label{sec:BH_BH}
...
to $5M_\odot-5M_\odot$ BBHs and only consider only ET-C.
For these systems, we find that $T_\text{AW} \lesssim 1\,$hour for $D\gtrsim 190\,$Mpc, but $\bar{\rho}_F$ exceeds 500 due to the increased total mass. Even for a source at 100\,Mpc, we obtain $T_\text{AW}\approx 35\,$minutes at best.
