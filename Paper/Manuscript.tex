...
with an additional $\sim 10$ hours to locate the optical transient now designated as AT 2017gfo.
...
Ref.~\cite{Cannon:2011vi} took up this challenge algorithmically and focused on developing inexpensive methods to detect inspiral
...
Cite the BNS Living review many times \cite{Faber:2012rw}.
 ...
 already attemps some forecast, but they focus on the search algorithm side of things
