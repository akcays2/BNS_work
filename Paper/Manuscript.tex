...
%
It can further be shown that there exist only two radiative degrees of freedom which physically manifest themselves as two independent polarization amplitudes $h_+$ and $h_\times$ of the GWs 
This fact is most easily demonstrated in the so-called transverse-traceless gauge (cf. Sec.~2.1 of Ref.~\cite{Flanagan:2005yc}). %when interacting with masses away from the source.
...
the initial source sky localization was 31\,deg$^2$ (later reduced to 28\,deg$^2$) using data from three IFOs \cite{GW170817}. 
...
Therfore, letting $f =2f_K= 1\,\text{Hz}$, i.e., 
