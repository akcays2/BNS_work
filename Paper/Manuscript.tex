...
On the other hand, Einstein Telescope will provide us with advance warning times of up to five hours.  
...
\ee
%
Here, $Q_{ij}$ is a trace-reversed {\bf MAYBE: explain this} mass quadrupole moment which
...
The quantity in parantheses in Eq.~(\ref{eq:Edot2}) equals $x^{3/2}$ where 
$x \equiv ({G M_c\, \Omega}/{c^3})^{2/3} $
is the dimensionless inverse separation parameter ubiquitous in post-Newtonian theory.
As $x\propto v^2/c^2$, it is used to keep track of post-Newtonian orders and we can see from Eq.~(\ref{eq:Edot2}) that $\dot{E}\propto x^5$. 
...
Let us briefly discuss the possibility of eccentric BNS systems {\bf FINISH}
\cite{1975MNRAS.172P..15F,Grindlay:2005ym}
%
%
