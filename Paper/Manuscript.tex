...
The mass bound we set above is only fully consistent with spinning black holes. This can be seen by substituting the naive Schwarzschild $r_\text{ISCO}$ value 
...
However, if the spin of the BH comes from the supernova explosion mechanism itself (as argued for G1915 in \cite{McClintock:2006xd} then this is not a problem.
 ...
 LIGO O1 merger rate  $ R < 3600\,$Gpc$^{-3}$yr$^{-1}$ \cite{Abbott:2016ymx}
