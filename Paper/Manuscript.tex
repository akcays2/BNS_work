...
\todo{1) See end of Sec. IV on page 13, 2) Finish new Sec VIII on BH-BH inspirals}
\end{abstract}
\maketitle
...
are completely random, there should be no preferred point in the angle parameter space, thus the result of the Monte-Carlo runs should converge
to the RMS average. Correspondingly, we would expect one of the other two IFOs to have somewhat higher sensitivity, and the other one to have lower sensitivity.
